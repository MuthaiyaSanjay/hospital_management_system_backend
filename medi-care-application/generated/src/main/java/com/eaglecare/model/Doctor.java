...
import com.eaglecare.model.ProfessionalInformation;
...
public class Doctor {
  ...
  @JsonProperty("professional_information")
  ...
  */
  ...
  public Doctor basicInfo(UserBasiInfo basicInfo) {
  ...
  */
  ...
  public Doctor contact(Contact contact) {
  ...
  */
  ...
  public Doctor professionalInformation(ProfessionalInformation professionalInformation) {
  ...
  */
  @Valid 
  @Schema(name = "professional_information", required = false)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, doctor.id) &&
        Objects.equals(this.basicInfo, doctor.basicInfo) &&
        Objects.equals(this.contact, doctor.contact) &&
        Objects.equals(this.professionalInformation, doctor.professionalInformation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, basicInfo, contact, professionalInformation);
  }
  ...
  public String toString() {
    ...
    sb.append("    professionalInformation: ").append(toIndentedString(professionalInformation)).append("\n");
    sb.append("}");
    return sb.toString();
  }
